...
public interface zzgo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgo {
        ...
        private static class C0812zza implements zzgo {
            private IBinder zzrk;

            C0812zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzgo zzz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgo)) ? new C0812zza(iBinder) : (zzgo) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 3:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.customrenderedad.client.ICustomRenderedAd");
                    zzi(IObjectWrapper.zza.zzcd(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 4:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.customrenderedad.client.ICustomRenderedAd");
