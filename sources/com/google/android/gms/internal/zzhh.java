...
public interface zzhh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhh {
        ...
        private static class C0815zza implements zzhh {
            private IBinder zzrk;

            C0815zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhh zzC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhh)) ? new C0815zza(iBinder) : (zzhh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zzd(parcel.readString(), IObjectWrapper.zza.zzcd(parcel.readStrongBinder()));
                ...
                case 5:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegate");
                    zzb(IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readInt());
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
