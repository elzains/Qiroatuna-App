...
public interface zzep extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzep {
        ...
        private static class C0799zza implements zzep {
        ...
        public static zzep zzm(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzep)) ? new C0799zza(iBinder) : (zzep) queryLocalInterface;
        }
