...
public interface zzkf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkf {
        ...
        private static class C0829zza implements zzkf {
            private IBinder zzrk;

            C0829zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzkf zzR(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkf)) ? new C0829zza(iBinder) : (zzkf) queryLocalInterface;
        }
