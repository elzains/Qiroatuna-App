...
public interface zzle extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzle {
        ...
        private static class C0833zza implements zzle {
            private IBinder zzrk;

            C0833zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzle zzX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzle)) ? new C0833zza(iBinder) : (zzle) queryLocalInterface;
        }
