...
public interface zzez extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzez {
        ...
        private static class C0809zza implements zzez {
            private IBinder zzrk;

            C0809zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzez zzv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzez)) ? new C0809zza(iBinder) : (zzez) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readInt());
