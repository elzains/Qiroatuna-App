...
public interface zznt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznt {
        ...
        private static class C0840zza implements zznt {
            private IBinder zzrk;

            C0840zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zznt zzag(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznt)) ? new C0840zza(iBinder) : (zznt) queryLocalInterface;
        }
