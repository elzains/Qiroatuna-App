...
public interface zzeo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeo {
        ...
        private static class C0798zza implements zzeo {
        ...
        public static zzeo zzl(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeo)) ? new C0798zza(iBinder) : (zzeo) queryLocalInterface;
        }
