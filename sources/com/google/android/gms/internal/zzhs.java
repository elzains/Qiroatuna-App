...
public interface zzhs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhs {
        ...
        private static class C0823zza implements zzhs {
            private IBinder zzrk;

            C0823zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhs zzK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhs)) ? new C0823zza(iBinder) : (zzhs) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzhn.zza.zzG(parcel.readStrongBinder()));
