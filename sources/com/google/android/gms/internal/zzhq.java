...
public interface zzhq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhq {
        ...
        private static class C0821zza implements zzhq {
            private IBinder zzrk;

            C0821zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhq zzI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhq)) ? new C0821zza(iBinder) : (zzhq) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzhl.zza.zzF(parcel.readStrongBinder()));
