...
public interface zzhp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhp {
        ...
        private static class C0820zza implements zzhp {
            private IBinder zzrk;

            C0820zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhp zzH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhp)) ? new C0820zza(iBinder) : (zzhp) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzhj.zza.zzE(parcel.readStrongBinder()));
