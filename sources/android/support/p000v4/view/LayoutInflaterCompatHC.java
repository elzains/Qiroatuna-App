...
class LayoutInflaterCompatHC {
    ...
    static class FactoryWrapperHC extends LayoutInflaterCompatBase.FactoryWrapper implements LayoutInflater.Factory2 {
        ...
        public View onCreateView(View parent, String name2, Context context, AttributeSet attributeSet) {
            return this.mDelegateFactory.onCreateView(parent, name2, context, attributeSet);
        }
    }
