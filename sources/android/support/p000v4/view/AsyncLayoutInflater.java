...
public final class AsyncLayoutInflater {
    ...
    private static class BasicInflater extends LayoutInflater {
        ...
        public View onCreateView(String name2, AttributeSet attrs) throws ClassNotFoundException {
            String[] strArr = sClassPrefixList;
            int length = strArr.length;
            int i = 0;
            while (i < length) {
                try {
                    View view = createView(name2, strArr[i], attrs);
                    if (view != null) {
                        return view;
                    }
                    i++;
            ...
            return super.onCreateView(name2, attrs);
        }
    }
