...
public final class ViewPropertyAnimatorCompat {
    ...
    interface ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        void mo2727x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void xBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: y */
        void mo2729y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void yBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: z */
        void mo2731z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        public void mo2727x(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: y */
        public void mo2729y(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: z */
        public void mo2731z(ViewPropertyAnimatorCompat vpa, View view, float value) {
        }
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo2689x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2727x(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo2691y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2729y(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo2693z(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2731z(this, view, value);
        }
        return this;
    }
