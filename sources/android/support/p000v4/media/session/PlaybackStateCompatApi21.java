...
class PlaybackStateCompatApi21 {
    ...
    static final class CustomAction {
        ...
        public static Object newInstance(String action, CharSequence name2, int icon, Bundle extras) {
            PlaybackState.CustomAction.Builder customActionObj = new PlaybackState.CustomAction.Builder(action, name2, icon);
