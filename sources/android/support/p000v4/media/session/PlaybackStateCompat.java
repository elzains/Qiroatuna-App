...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class CustomAction implements Parcelable {
        ...
        CustomAction(String action, CharSequence name2, int icon, Bundle extras) {
            this.mAction = action;
            this.mName = name2;
            this.mIcon = icon;
            this.mExtras = extras;
        ...
        public static final class Builder {
            ...
            public Builder(String action, CharSequence name2, int icon) {
    ...
    public static final class Builder {
        ...
        public Builder addCustomAction(String action, String name2, int icon) {
            return addCustomAction(new CustomAction(action, name2, icon, (Bundle) null));
        }
