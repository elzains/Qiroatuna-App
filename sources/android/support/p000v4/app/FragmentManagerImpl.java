...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    public void popBackStack(String name2, int flags) {
        enqueueAction(new PopBackStackState(name2, -1, flags), false);
    }

    public boolean popBackStackImmediate(String name2, int flags) {
        checkStateLoss();
        return popBackStackImmediate(name2, -1, flags);
    }
    ...
    private boolean popBackStackImmediate(String name2, int id, int flags) {
        execPendingActions();
        ensureExecReady(true);
        boolean executePop = popBackStackState(this.mTmpRecords, this.mTmpIsPop, name2, id, flags);
        if (executePop) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:193:0x05c7, code lost:
        ...
        r18.setStateAfterAnimating(r19);
        r10.setAnimationListener(new android.support.p000v4.app.FragmentManagerImpl.C00132(r17, r18.mView, r10));
    ...
    /* access modifiers changed from: package-private */
    public boolean popBackStackState(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, String name2, int id, int flags) {
        if (this.mBackStack == null) {
            return false;
        }
        if (name2 == null && id < 0 && (flags & 1) == 0) {
            ...
            if (name2 != null || id >= 0) {
                ...
                while (index >= 0) {
                    ...
                    if ((name2 != null && name2.equals(bss.getName())) || (id >= 0 && id == bss.mIndex)) {
                        break;
                    }
                    index2 = index - 1;
                }
                ...
                if ((flags & 1) != 0) {
                    ...
                    while (index >= 0) {
                        ...
                        if ((name2 == null || !name2.equals(bss2.getName())) && (id < 0 || id != bss2.mIndex)) {
                            break;
                        }
                        index--;
                    }
    ...
    private class PopBackStackState implements OpGenerator {
        ...
        PopBackStackState(String name2, int id, int flags) {
            this.mName = name2;
            this.mId = id;
            this.mFlags = flags;
        }
