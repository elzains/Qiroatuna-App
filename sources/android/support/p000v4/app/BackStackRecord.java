...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    String mName;
    ArrayList<C0006Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                C0006Op op = this.mOps.get(opNum);
                switch (op.cmd) {
                    case 0:
                        cmdStr = "NULL";
                        break;
    ...
    public FragmentTransaction addSharedElement(View sharedElement, String name2) {
        if (SUPPORTS_TRANSITIONS) {
            ...
            } else if (this.mSharedElementTargetNames.contains(name2)) {
                throw new IllegalArgumentException("A shared element with the target name '" + name2 + "' has already been added to the transaction.");
            } else if (this.mSharedElementSourceNames.contains(transitionName)) {
                throw new IllegalArgumentException("A shared element with the source name '" + transitionName + " has already been added to the transaction.");
            }
            this.mSharedElementSourceNames.add(transitionName);
            this.mSharedElementTargetNames.add(name2);
        }
        return this;
    }
    ...
    public FragmentTransaction addToBackStack(String name2) {
    ...
    private static boolean isFragmentPostponed(C0006Op op) {
