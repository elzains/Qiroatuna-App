...
public class FileProvider extends ContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String authority) throws IOException, XmlPullParserException {
        ...
        while (true) {
            ...
            if (type == 2) {
                ...
                String name2 = in.getAttributeValue((String) null, ATTR_NAME);
                ...
                if (target != null) {
                    strat.addRoot(name2, buildPath(target, path));
                }
            }
        }
    }
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public void addRoot(String name2, File root) {
            if (TextUtils.isEmpty(name2)) {
                throw new IllegalArgumentException("Name must not be empty");
            }
            try {
                this.mRoots.put(name2, root.getCanonicalFile());
            } catch (IOException e) {
