    ...
    private class CustomConfigXmlParser extends ConfigXmlParser {
        ...
        public void handleStartTag(XmlPullParser xml) {
            ...
            if (strNode.equals("content")) {
                WhitelistPlugin.this.allowedNavigations.addWhiteListEntry(xml.getAttributeValue((String) null, "src"), false);
            } else if (strNode.equals("allow-navigation")) {
                String origin = xml.getAttributeValue((String) null, "href");
                if ("*".equals(origin)) {
                ...
                WhitelistPlugin.this.allowedIntents.addWhiteListEntry(xml.getAttributeValue((String) null, "href"), false);
            } else if (strNode.equals("access")) {
                String origin2 = xml.getAttributeValue((String) null, "origin");
                String subdomains = xml.getAttributeValue((String) null, "subdomains");
                if (xml.getAttributeValue((String) null, "launch-external") != null) {
                    external = true;
                } else {
                    external = false;
                }
